...
__all__ = [
    'DISPID_SVWaitUntilDone', 'SpeechRunState',
    'DISPID_SPIAudioStreamPosition', 'SPEI_MAX_TTS', 'SVSFIsXML',
    'DISPID_SVEStreamStart', 'SREPropertyNumChange',
    'DISPID_SPIReplacements', 'SpeechWordType', 'DISPID_SOTId',
    'DISPID_SOTDataKey', 'ISpeechAudio', 'SSFMOpenForRead',
    'DISPID_SABIMinNotification', 'DISPID_SGRSTsItem', 'SRAExport',
    'SFTInput', 'ISpRecognizer', 'DISPID_SWFEFormatTag',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRRTTickCount',
    'DISPID_SpeechRecoContext', 'SpShortcut', 'SPEI_MIN_TTS',
    'DISPID_SRCEAudioLevel', 'SVF_Emphasis', 'SASClosed',
    'DISPID_SVEventInterests', 'SPINTERFERENCE_TOOFAST',
    'SpeechAudioVolume', 'ISpeechDataKey', 'SP_VISEME_18',
    'DISPID_SpeechObjectToken', 'SPBO_AHEAD', 'SAFTADPCM_8kHzStereo',
    'SBOPause', 'DISPID_SRSetPropertyString',
    'DISPID_SRGetPropertyString', 'SAFT44kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SpLexicon', 'DISPID_SGRAddResource',
    'SpCustomStream', 'ISpPhoneticAlphabetConverter',
    'DISPID_SLPSymbolic', 'eLEXTYPE_PRIVATE5', 'SpMemoryStream',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SFSClose',
    'SpeechEngineConfidence', 'DISPID_SpeechVoice',
    'SpeechVoiceEvents', 'DISPID_SAFGuid', 'ISpRecognizer2',
    'DISPID_SPAsItem', 'DISPID_SRGId', 'SAFT12kHz16BitMono',
    'DISPID_SRSSupportedLanguages', 'SPAUDIOOPTIONS',
    'SDTDisplayText', 'SSFMCreate', 'SWTAdded',
    'DISPID_SDKSetBinaryValue', 'ISpeechRecognizer',
    'DISPID_SPRs_NewEnum', 'SpeechCategoryAudioOut',
    'DISPID_SVEPhoneme', 'DISPID_SPIEnginePrivateData', 'SVP_3',
    'SPPHRASE', 'SP_VISEME_9', 'SpeechTokenShellFolder', 'SVPNormal',
    'SpeechRecognizerState', 'DISPID_SOTCGetDataKey',
    'SPXRO_Alternates_SML', 'SECFIgnoreCase',
    'DISPID_SRSCurrentStreamNumber', 'SpSharedRecognizer',
    'ISpeechAudioStatus', 'ISpeechPhraseReplacement',
    'SWPKnownWordPronounceable', 'DISPID_SPEPronunciation',
    'ISpeechObjectToken', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_RESERVED3', 'SGDSInactive', 'DISPID_SGRSTransitions',
    'SpTextSelectionInformation', 'SAFTCCITT_uLaw_44kHzMono',
    'IEnumString', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRGetRecognizers',
    'DISPID_SWFESamplesPerSec', 'DISPID_SGRSTNextState',
    'DISPID_SPIRetainedSizeBytes', 'SPXRO_SML', 'SpVoice',
    'DISPID_SLPLangId', 'DISPID_SPPs_NewEnum', 'SPWT_DISPLAY',
    'DISPID_SBSFormat', 'SP_VISEME_7', 'DISPID_SOTGetStorageFileName',
    'SPWORDPRONUNCIATIONLIST', 'SECNormalConfidence',
    'SPFM_OPEN_READWRITE', 'SRTReSent', 'ISpRecoGrammar',
    'SPEVENTENUM', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'eWORDTYPE_DELETED', 'SVSFNLPSpeakPunc', 'SPLO_STATIC',
    'SPDKL_CurrentConfig', 'DISPID_SVSLastResult',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVEWord', 'SPSMF_UPS',
    'DISPID_SPEDisplayText', 'DISPID_SADefaultFormat',
    'DISPID_SAEventHandle', 'ISpeechRecoGrammar',
    'SpeechBookmarkOptions', 'ISpRecognizer3', 'SECFDefault',
    'SVSFParseSapi', 'DISPID_SMSGetData', 'SRERecoOtherContext',
    'SPPS_Noun', 'SPFILEMODE', 'SVEWordBoundary',
    'DISPID_SRRecognizer', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPAPhraseInfo', 'SSTTWildcard', 'DISPID_SMSSetData',
    'SpInprocRecognizer', 'DISPID_SVSpeak', 'SECHighConfidence',
    'SP_VISEME_19', 'SINone', 'ISpeechRecoContext',
    'DISPID_SOTGetAttribute', 'ISpeechPhoneConverter',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SMSALineId',
    'SSFMOpenReadWrite', 'DISPID_SGRsAdd', 'SLTUser',
    'ISpeechPhraseProperties', 'SPEI_SOUND_START',
    'SAFT11kHz16BitMono', 'SpeechUserTraining', 'DISPID_SPAsCount',
    'DISPID_SABufferInfo', 'DISPID_SBSWrite', 'SWTDeleted',
    'DISPID_SVVolume', 'ISpResourceManager', 'DISPID_SOTCId',
    'SDTRule', 'SPINTERFERENCE_NOISE', 'SPWORDPRONUNCIATION',
    'SPPS_RESERVED2', 'DISPID_SAStatus',
    'DISPID_SpeechPhraseProperties', 'SPEI_HYPOTHESIS',
    'SAFTGSM610_8kHzMono', 'SPRST_INACTIVE_WITH_PURGE',
    'SpeechRecoContextState', 'SPCT_DICTATION', 'SpFileStream',
    'SRSActiveAlways', 'DISPID_SRState', 'DISPID_SVESentenceBoundary',
    'SVP_13', 'SREPhraseStart', 'SGLexical',
    'DISPID_SLWPronunciations', 'SINoSignal', 'SPWORDPRONOUNCEABLE',
    'SPSInterjection', 'UINT_PTR', 'SPAR_High',
    'SDA_No_Trailing_Space', 'DISPID_SGRsFindRule',
    'SGDSActiveUserDelimited', 'SpCompressedLexicon',
    'DISPID_SPIElements', 'DISPID_SRGIsPronounceable',
    'DISPID_SASCurrentSeekPosition', 'SVSFIsNotXML', 'SPSLMA',
    'ISpeechLexicon', 'ISpeechLexiconPronunciations',
    'SPGRAMMARWORDTYPE', 'ISpeechFileStream',
    'SpeechDisplayAttributes', 'SVP_12', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SAFType', 'DISPID_SLWWord', 'SpeechCategoryVoices',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEHypothesis',
    'SP_VISEME_12', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCRequestedUIType',
    'SDKLLocalMachine', 'STCInprocServer', 'SAFT16kHz16BitMono',
    'SPWF_INPUT', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTADPCM_11kHzMono', 'SPRST_ACTIVE',
    'DISPID_SpeechPhraseElement', 'IStream', 'DISPID_SOTCategory',
    'SPGS_ENABLED', '_SPAUDIOSTATE', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEInterference', 'SPEI_RESERVED1',
    'DISPID_SWFEExtraData', 'DISPID_SRGetFormat', 'SPVPRI_NORMAL',
    'ISpStreamFormatConverter', 'DISPID_SPRuleNumberOfElements',
    'SP_VISEME_20', 'ISpeechWaveFormatEx', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE10', 'SVP_0', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPRulesItem', 'DISPID_SPPConfidence',
    'SAFTADPCM_8kHzMono', 'SpeechPropertyResourceUsage',
    'DISPID_SDKCreateKey', 'SPADAPTATIONRELEVANCE',
    'eLEXTYPE_MORPHOLOGY', 'SPVPRI_ALERT', 'ISpLexicon', 'SGRSTTRule',
    'SPRST_INACTIVE', 'DISPID_SpeechFileStream',
    'DISPID_SOTDisplayUI', 'SPWF_SRENGINE', 'SDTPronunciation',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SVSpeakStream',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechPhraseInfo', 'DISPID_SPPsItem',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPPName',
    'SpeechRuleState', 'SAFT16kHz8BitStereo', 'ISpRecoGrammar2',
    'SpeechVisemeType', 'DISPID_SVRate', 'ISpRecoResult',
    'SPBO_TIME_UNITS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SGRSTsCount', 'ISpDataKey',
    'ISpeechTextSelectionInformation', 'SGRSTTTextBuffer',
    'DISPID_SPPsCount', 'SPFM_CREATE', 'tagSPPROPERTYINFO',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechAudio', 'SREStreamStart',
    'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE3', 'SVSFlagsAsync',
    'DISPID_SRRTimes', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRuleEngineConfidence', 'ISpeechPhraseInfo',
    'SAFT44kHz8BitStereo', 'DISPID_SGRSAddRuleTransition',
    'SPEI_RESERVED6', 'SREAdaptation', 'SPRECOGNIZERSTATUS',
    'SAFT16kHz16BitStereo', 'DISPID_SOTGetDescription',
    'eLEXTYPE_USER', 'SSSPTRelativeToCurrentPosition',
    'SpeechDataKeyLocation', 'DISPID_SMSADeviceId',
    'DISPID_SLPsCount', 'DISPID_SAFGetWaveFormatEx',
    'SAFTADPCM_44kHzStereo', 'SVEBookmark', 'DISPID_SPRuleId',
    'DISPID_SLGenerationId', 'SP_VISEME_10', 'SpeechCategoryAudioIn',
    'ISpPhoneConverter', 'DISPID_SpeechLexiconWord',
    'DISPID_SVEVoiceChange', 'SGSDisabled', 'SPXMLRESULTOPTIONS',
    'SPSNoun', 'SPFM_CREATE_ALWAYS', 'SRTStandard',
    'SPEI_START_INPUT_STREAM', 'SVSFPurgeBeforeSpeak',
    '_ISpeechRecoContextEvents', 'ISpeechObjectTokens',
    'ISpeechLexiconWords', 'DISPID_SPAs_NewEnum',
    'tagSPTEXTSELECTIONINFO', 'SP_VISEME_5', 'DISPID_SPPFirstElement',
    'DISPID_SLGetPronunciations', 'SVEPhoneme', 'SGRSTTEpsilon',
    'DISPID_SLWLangId', 'SPLEXICONTYPE',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_Verb', 'SVP_18',
    'DISPID_SRGCmdSetRuleIdState', 'ISpAudio', 'DISPID_SPILanguageId',
    'SPPHRASEPROPERTY', 'DISPID_SPRFirstElement', 'SpObjectToken',
    'SPINTERFERENCE_TOOQUIET', 'SPSUnknown', 'SPEI_RESERVED5',
    'SSFMCreateForWrite', 'SVSFNLPMask',
    'DISPID_SVSInputSentenceLength', 'DISPID_SLGetGenerationChange',
    'DISPID_SPRsItem', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPWT_PRONUNCIATION', 'DISPID_SRGDictationUnload',
    'SPAUDIOBUFFERINFO', 'SDA_One_Trailing_Space', 'DISPID_SVEViseme',
    'SGRSTTWord', 'SAFT22kHz8BitStereo', 'DISPID_SRRAudioFormat',
    'SRATopLevel', 'SPWORDLIST', 'SAFTNonStandardFormat',
    'DISPID_SOTCSetId', 'DISPID_SPPId', 'DISPID_SRCEventInterests',
    'ISpProperties', 'SAFT24kHz16BitMono', 'STSF_LocalAppData',
    'SRAONone', 'SAFTDefault', 'eLEXTYPE_RESERVED6', 'SP_VISEME_11',
    'SPAS_PAUSE', 'SpeechTokenKeyAttributes', 'SpMMAudioEnum',
    'SWPUnknownWordPronounceable', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechLexiconWords', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE11', 'DISPID_SpeechRecognizer',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPRText', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCERequestUI', 'SVSFIsFilename',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechRetainedAudioOptions',
    'DISPID_SGRs_NewEnum', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechPhraseBuilder', 'SPPS_RESERVED3', 'DISPID_SRCPause',
    'SP_VISEME_15', 'SPAR_Low', 'DISPID_SOTCEnumerateTokens',
    'SpPhraseInfoBuilder', 'DISPID_SVSRunningState',
    'ISpeechAudioBufferInfo', 'SpeechTokenKeyUI', 'DISPIDSPTSI',
    'SECFNoSpecialChars', 'DISPID_SVSInputWordPosition',
    'DISPID_SPIGetText', 'DISPID_SpeechBaseStream',
    'DISPID_SPISaveToMemory', 'DISPID_SRCEBookmark',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGState',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SGRSTPropertyValue', 'SpeechTokenContext',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRCESoundEnd',
    'SPPHRASEELEMENT', 'SVP_14', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED4', 'SPEI_WORD_BOUNDARY',
    'SpeechCategoryRecognizers', 'DISPID_SVEStreamEnd',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SVSInputWordLength', 'SPLO_DYNAMIC',
    'SDA_Consume_Leading_Spaces', 'SRSInactiveWithPurge',
    'DISPID_SDKGetBinaryValue', 'IInternetSecurityManager',
    'SPEI_PROPERTY_NUM_CHANGE', 'SREPropertyStringChange',
    'Speech_Max_Pron_Length', 'SpeechDictationTopicSpelling',
    'DISPID_SRCEEnginePrivate', 'SGRSTTDictation', 'SASRun',
    'SpeechRecoProfileProperties', 'SRSActive', 'SPVOICESTATUS',
    'SECLowConfidence', 'SDTReplacement', 'SPSNotOverriden',
    'SPAS_STOP', 'DISPID_SGRSTType', 'ISpeechMemoryStream',
    'ISpeechRecoResult', 'SpeechFormatType', 'LONG_PTR',
    'SPEI_VISEME', 'SP_VISEME_13', 'SpResourceManager', 'SPAO_NONE',
    'DISPID_SBSRead', 'DISPID_SVSkip', 'SRERequestUI',
    'SPSERIALIZEDPHRASE', 'SPEI_UNDEFINED', 'SGSEnabled',
    'DISPID_SpeechAudioStatus', 'SVSFParseMask',
    'DISPID_SRCESoundStart', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechResourceLoader', 'SAFT48kHz16BitStereo',
    'Speech_StreamPos_RealTime', 'SPVISEMES',
    'ISpeechPhraseAlternate', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechVoiceEvent', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechCustomStream', 'DISPID_SRCRecognizer',
    'DISPID_SVSVisemeId', 'ISpEventSink', 'ISpeechGrammarRule',
    'SpeechMicTraining', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPRuleConfidence', 'SPPS_Interjection', 'DISPID_SGRsItem',
    'SVESentenceBoundary', 'DISPID_SRGSetWordSequenceData',
    'SpObjectTokenCategory', 'SRARoot', 'DISPID_SRCState',
    'DISPID_SLWs_NewEnum', 'SAFT24kHz8BitMono', 'ISpRecoContext',
    'SPEI_RECO_STATE_CHANGE', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSAddSpecialTransition', 'SPDKL_LocalMachine',
    'SPRECORESULTTIMES', 'DISPID_SGRSRule', 'DISPID_SRCResume',
    'DISPID_SRRGetXMLResult', 'SVSFDefault',
    'DISPID_SpeechPhraseReplacements', 'SPLOADOPTIONS',
    'eLEXTYPE_PRIVATE13', 'SPRECOCONTEXTSTATUS', 'SVP_8',
    'SpeechAudioState', 'DISPID_SVAlertBoundary',
    'DISPID_SABIBufferSize', 'SFTSREngine', 'DISPID_SpeechLexicon',
    'SAFT44kHz16BitMono', 'SpeechLoadOption',
    'DISPID_SRCSetAdaptationData', 'SP_VISEME_8',
    'DISPID_SRCRetainedAudioFormat', 'SAFT48kHz8BitMono',
    'SVSFPersistXML', 'SPEI_SR_BOOKMARK',
    'SAFTCCITT_uLaw_22kHzStereo', '__MIDL_IWinTypes_0009',
    'SGDSActiveWithAutoPause', 'DISPID_SRRSaveToMemory',
    'DISPID_SGRAttributes', 'DISPID_SPEAudioSizeTime',
    'DISPID_SDKEnumKeys', 'SRERecognition', 'SPCT_SUB_DICTATION',
    'SRESoundStart', 'SPBO_PAUSE', 'DISPID_SOTsCount',
    'ISpObjectToken', 'eLEXTYPE_PRIVATE8', 'SAFT44kHz16BitStereo',
    'SPSEMANTICFORMAT', 'SAFTADPCM_22kHzMono', 'SVP_15',
    'DISPID_SPELexicalForm', 'eLEXTYPE_PRIVATE18', 'SVP_19',
    'DISPID_SVSLastBookmark', 'eWORDTYPE_ADDED',
    'SWPUnknownWordUnpronounceable', 'SVF_None', 'SREBookmark',
    'DISPID_SPRuleName', 'SpUnCompressedLexicon',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE6',
    'ISpeechXMLRecoResult', 'SPBO_NONE',
    'DISPID_SpeechPhraseElements', 'SPSERIALIZEDRESULT', 'SRADynamic',
    'SPGRAMMARSTATE', 'DISPID_SRSetPropertyNumber',
    'DISPIDSPTSI_SelectionOffset', 'SVPAlert',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechAudioBufferInfo',
    'STCRemoteServer', 'SpeechDiscardType', 'SRTExtendableParse',
    'DISPID_SRRRecoContext', 'SDKLCurrentUser', 'SPEI_MIN_SR',
    'SSSPTRelativeToEnd', 'SECFIgnoreKanaType',
    'DISPID_SABIEventBias', 'DISPID_SPEsCount',
    'DISPID_SpeechGrammarRule', 'SPDKL_DefaultLocation',
    'Speech_StreamPos_Asap', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRAudioInputStream', 'DISPID_SLWsItem', 'SGDisplay',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_PRIVATE7',
    'SPPS_Modifier', 'SVP_9', 'SPRULESTATE',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRGCmdLoadFromObject',
    'SVP_16', 'SRCS_Enabled', 'DISPID_SRSClsidEngine',
    'DISPID_SPEAudioTimeOffset', 'SPINTERFERENCE_TOOSLOW',
    'SPRS_ACTIVE', 'DISPID_SCSBaseStream', 'DISPID_SRGRecoContext',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechMemoryStream',
    'SAFTCCITT_uLaw_11kHzMono', 'ISequentialStream',
    'SPPS_SuppressWord', 'SSSPTRelativeToStart', 'SECFEmulateResult',
    'Speech_Default_Weight', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechAllElements', 'SAFTADPCM_22kHzStereo',
    'SpeechCategoryRecoProfiles', 'SVP_1', 'SVP_5',
    'DISPID_SWFEChannels', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVEEndInputStream', 'SRSEDone', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE4', 'SPPS_RESERVED1',
    'SPEI_SOUND_END', 'SPSFunction', 'DISPID_SPIStartTime',
    'DISPID_SPEActualConfidence', 'DISPID_SGRsCount',
    'SAFT22kHz16BitMono', 'SAFT11kHz8BitStereo',
    'DISPID_SRAudioInput', 'DISPID_SPCPhoneToId',
    'SpeechStreamSeekPositionType', 'SVPOver',
    'DISPID_SDKGetStringValue', 'DISPID_SVDisplayUI', 'SPEVENT',
    'ISpVoice', 'ISpeechPhraseElements', 'SP_VISEME_17',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPERequiredConfidence',
    'DISPID_SRProfile', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRCCreateGrammar', 'ISpSerializeState',
    'DISPID_SVGetProfiles', 'SPBINARYGRAMMAR',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPACommit',
    'DISPID_SOTsItem', 'DISPID_SRCVoice', 'SDKLDefaultLocation',
    'SAFT48kHz16BitMono', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCEFalseRecognition', 'SVP_4', 'DISPID_SVVoice',
    'DISPID_SVAudioOutput', 'DISPIDSPTSI_SelectionLength',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPRuleFirstElement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVSLastBookmarkId', 'SAFT16kHz8BitMono',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SVGetAudioOutputs',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFT11kHz8BitMono',
    'SpWaveFormatEx', 'DISPID_SVGetAudioInputs', 'ISpeechPhraseRules',
    'SAFTADPCM_44kHzMono', 'SAFT32kHz16BitStereo',
    'IEnumSpObjectTokens', 'DISPID_SRCreateRecoContext',
    'SPBOOKMARKOPTIONS', 'SLOStatic', 'ISpeechMMSysAudio',
    'STCLocalServer', 'SAFTGSM610_22kHzMono', 'DISPID_SVGetVoices',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SLPType', 'DISPID_SVStatus',
    'SPPS_NotOverriden', 'DISPID_SVEAudioLevel', 'SpAudioFormat',
    'SpMMAudioIn', 'SP_VISEME_21', 'SPPHRASERULE',
    'SAFT12kHz8BitMono', 'SPEI_END_INPUT_STREAM', 'SPSVerb',
    'ISpNotifySource', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechPhraseReplacement', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCBookmark', 'DISPID_SPIEngineId',
    'DISPID_SWFEBlockAlign', 'STSF_FlagCreate', 'SVP_2',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRAddState', 'ISpRecoContext2', 'ISpeechLexiconWord',
    'DISPID_SPEEngineConfidence', 'DISPID_SRGRules',
    'SAFTNoAssignedFormat', 'DISPID_SpeechVoiceStatus',
    'SAFT32kHz16BitMono', 'SPVPRI_OVER', 'SPSHT_OTHER',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SASetState',
    'ISpeechRecoResultTimes', 'DISPID_SVSPhonemeId',
    'SPSHT_NotOverriden', 'DISPID_SRCEStartStream', 'DISPID_SLWType',
    'DISPID_SPRules_NewEnum',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEBitsPerSample', 'SLODynamic',
    'ISpPhoneticAlphabetSelection', 'SP_VISEME_3', 'ISpPhraseAlt',
    'DISPID_SpeechDataKey', 'DISPID_SABufferNotifySize',
    'DISPID_SGRId', 'DISPID_SPRulesCount', 'SASStop',
    'ISpeechGrammarRules', 'SPFM_OPEN_READONLY',
    'SREFalseRecognition', 'ISpeechPhraseReplacements', 'tagSTATSTG',
    'DISPID_SVResume', 'DISPID_SFSOpen', 'DISPID_SRRGetXMLErrorInfo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechPhraseAlternates', 'DISPID_SMSAMMHandle',
    'SpeechTokenValueCLSID', 'SVEAudioLevel', 'DISPID_SVEBookmark',
    'SpeechGrammarWordType', 'SPAUDIOSTATE',
    'DISPID_SpeechPhraseAlternates', 'SAFT11kHz16BitStereo',
    'SVEStartInputStream', 'DISPID_SpeechPhoneConverter',
    'SPRS_INACTIVE', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SVSCurrentStreamNumber', 'SRTSMLTimeout',
    'DISPID_SOTs_NewEnum', 'SRCS_Disabled', 'SPVPRIORITY',
    'SPEI_SR_RETAINEDAUDIO', 'SECFIgnoreWidth', 'SREAudioLevel',
    'SPPS_Noncontent', 'SAFT8kHz8BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'SITooFast', 'SITooQuiet',
    'DISPID_SLPPhoneIds', 'SPSTREAMFORMATTYPE', 'SPSModifier',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRAImport', 'ISpRecoCategory',
    'DISPID_SGRsCommitAndSave', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPRuleParent', 'ISpShortcut', 'SPWORDTYPE',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGCmdSetRuleState', 'SPRST_NUM_STATES',
    'SpeechTokenKeyFiles', 'SSTTTextBuffer', 'DISPID_SPARecoResult',
    'DISPID_SPRsCount', 'SpeechAudioProperties', 'ISpeechRecoResult2',
    'DISPID_SDKSetStringValue', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRuleChildren',
    'SVF_Stressed', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPSHT_Unknown', 'DISPID_SRCEAdaptation', 'SPEI_MAX_SR',
    'SpeechPartOfSpeech', 'SPAUDIOSTATUS', 'ISpeechPhraseRule',
    'SPEI_END_SR_STREAM', 'SRESoundEnd', 'SpeechAudioFormatGUIDWave',
    'DISPID_SVPriority', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRSAudioStatus', 'SPCS_ENABLED', 'SLTApp',
    'SpeechRegistryUserRoot', 'SREInterference',
    'SpPhoneticAlphabetConverter', 'SPRST_ACTIVE_ALWAYS',
    'SpeechWordPronounceable', 'SPEI_START_SR_STREAM',
    'SpeechTokenIdUserLexicon', 'SVP_11', 'SAFTText',
    'DISPID_SRGCmdLoadFromResource', '_RemotableHandle',
    'DISPID_SAVolume', 'DISPID_SpeechLexiconPronunciation',
    'SpeechStreamFileMode', 'SAFT32kHz8BitMono',
    'DISPID_SpeechGrammarRuleState', 'ISpeechPhraseInfoBuilder',
    'DISPID_SREmulateRecognition', 'SREStateChange',
    'DISPID_SRRSetTextFeedback', 'Speech_Max_Word_Length', 'SBONone',
    'ISpXMLRecoResult', 'ISpeechCustomStream', 'SREStreamEnd',
    'SPTEXTSELECTIONINFO', 'SRAInterpreter', 'eLEXTYPE_VENDORLEXICON',
    'SP_VISEME_4', 'SpStream', 'DISPID_SGRName', 'STSF_CommonAppData',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE2', 'SP_VISEME_2',
    'eLEXTYPE_PRIVATE1', 'DISPID_SGRSAddWordTransition',
    'SpStreamFormatConverter', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCEPhraseStart', 'SPRECOSTATE', 'DISPID_SGRClear',
    'DISPID_SOTCDefault', 'SRTAutopause', 'eLEXTYPE_PRIVATE16',
    'DISPID_SGRSTRule', 'SREAllEvents', 'DISPID_SPERetainedSizeBytes',
    'SPSSuppressWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPROPERTYINFO',
    'SPSHORTCUTPAIRLIST', 'SAFTADPCM_11kHzStereo', 'SPEI_ADAPTATION',
    'SVP_6', 'SINoise', 'DISPID_SRRTStreamTime',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechObjectTokenCategory',
    'SREHypothesis', 'SVP_20', 'eLEXTYPE_APP',
    'DISPID_SRCAudioInInterferenceStatus', 'SP_VISEME_16',
    'DISPID_SPPEngineConfidence', 'SpeechAudioFormatType',
    'eLEXTYPE_PRIVATE9', 'ISpObjectTokenCategory',
    'DISPID_SDKOpenKey', 'DISPIDSPTSI_ActiveLength',
    'SpeechRecoEvents', 'SVEViseme', 'SpeechAudioFormatGUIDText',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVSFUnusedFlags',
    'SPAS_RUN', 'DISPID_SASNonBlockingIO',
    'DISPID_SRCEPropertyNumberChange', 'SpeechPropertyResponseSpeed',
    'DISPID_SRGetPropertyNumber', 'SAFTCCITT_ALaw_11kHzStereo',
    'SRTEmulated', 'DISPID_SASState', 'SpMMAudioOut', 'SDTAll',
    'DISPID_SLRemovePronunciation', 'ISpPhrase',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPDKL_CurrentUser', 'SITooSlow',
    'SPCT_SLEEP', 'DISPID_SGRSTWeight',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechVoiceStatus',
    'DISPID_SVSpeakCompleteEvent', 'SpeechPropertyAdaptationOn',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRGReset', 'SPGS_EXCLUSIVE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGDictationSetState', 'SPGS_DISABLED', 'SDTAudio',
    'DISPID_SRIsUISupported', 'DISPID_SPIProperties',
    'DISPID_SLGetWords', 'ISpeechRecognizerStatus', 'SRSEIsSpeaking',
    'DISPID_SRGCommit', 'SPWORD', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRSCurrentStreamPosition', 'ISpNotifySink',
    'SPEI_PHONEME', 'SAFTGSM610_44kHzMono', 'DISPID_SGRSTPropertyId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPFM_NUM_MODES',
    'SpeechInterference', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRTOffsetFromStart',
    'STCAll', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechGrammarRules', 'SPPS_Function', 'DISPIDSPRG',
    'SPAS_CLOSED', 'SDTProperty', 'DISPID_SRIsShared',
    'SpeechSpecialTransitionType', 'SAFT22kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpStreamFormat',
    'DISPID_SpeechPhraseAlternate',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_0',
    'SITooLoud', 'DISPID_SRDisplayUI', 'SAFTCCITT_ALaw_8kHzMono',
    'SGPronounciation', 'DISPID_SPPValue', 'SPINTERFERENCE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAR_Medium',
    'SRADefaultToActive', 'SPEI_REQUEST_UI', 'SPDATAKEYLOCATION',
    'SVSFParseSsml', 'SP_VISEME_14', 'SPEI_TTS_BOOKMARK', 'SVP_7',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPParent', 'ISpeechAudioFormat',
    'SpeechVisemeFeature', 'SPPS_Unknown',
    'ISpeechGrammarRuleStateTransitions', 'SVSFVoiceMask',
    'eLEXTYPE_RESERVED8', 'STCInprocHandler', 'DISPID_SGRSTs_NewEnum',
    'SPEVENTSOURCEINFO', 'SpSharedRecoContext', 'DISPID_SPEs_NewEnum',
    'DISPID_SRCEPropertyStringChange', 'SGSExclusive',
    'SPCT_SUB_COMMAND', 'SPRULE', 'SGRSTTWildcard',
    'DISPID_SLWsCount', 'SGLexicalNoSpecialChars',
    'ISpeechGrammarRuleStateTransition', 'SREPrivate', 'SVEPrivate',
    'SP_VISEME_1', 'ISpNotifyTranslator', 'SpeechRuleAttributes',
    'SPEI_PHRASE_START', 'SpeechVoiceSpeakFlags', 'DISPID_SRRAudio',
    'SRAORetainAudio', 'STSF_AppData', 'DISPID_SPIGrammarId',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RESERVED2', 'SSTTDictation',
    'SPPHRASEREPLACEMENT', 'DISPID_SVAudioOutputStream',
    'SAFT22kHz8BitMono', 'SpeechEngineProperties', 'DISPID_SOTSetId',
    'SVSFParseAutodetect', 'SpeechLexiconType', 'SPPARTOFSPEECH',
    'SPSHORTCUTTYPE', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SVEVoiceChange', 'eLEXTYPE_RESERVED7', 'SPEI_INTERFERENCE',
    'SPWAVEFORMATTYPE', 'SGDSActive', 'DISPID_SRGDictationLoad',
    'ISpeechGrammarRuleState', 'DISPID_SRRTLength',
    'ISpeechBaseStream', 'DISPID_SRCERecognition',
    'SpeechGrammarTagWildcard', 'SpeechRecognitionType',
    'DISPID_SpeechAudioFormat', 'SpeechVoicePriority',
    'DISPID_SOTRemove', 'SVP_10', 'DISPID_SpeechRecoContextEvents',
    'SAFT48kHz8BitStereo', 'IInternetSecurityMgrSite', 'SVP_17',
    'SASPause', 'DISPID_SPCIdToPhone', 'SpNotifyTranslator',
    'SPINTERFERENCE_NONE', 'SVEAllEvents', 'ISpObjectWithToken',
    'SDTLexicalForm', 'DISPID_SpeechPhraseProperty', 'ISpeechVoice',
    'ISpStream', 'SAFTExtendedAudioFormat', 'SPPS_RESERVED4',
    'SP_VISEME_6', 'DISPID_SGRsCommit', 'DISPID_SGRInitialState',
    'DISPID_SGRSTPropertyName', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRRAlternates', 'SpeechCategoryPhoneConverters',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIRule',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SpeechLexiconProns',
    'SPWT_LEXICAL', 'ISpeechPhraseElement', 'eLEXTYPE_PRIVATE15',
    'eLEXTYPE_PRIVATE20', 'ISpeechPhraseProperty',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPCS_DISABLED',
    'SPSEMANTICERRORINFO', 'SPEI_RECOGNITION',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT24kHz16BitStereo',
    'DISPID_SPAStartElementInResult', 'SAFT12kHz16BitStereo',
    'DISPID_SLPsItem', 'SAFT12kHz8BitStereo', 'WAVEFORMATEX',
    'SAFT8kHz16BitMono', 'DISPID_SOTIsUISupported', 'DISPID_SRStatus',
    'DISPID_SpeechRecoResult', 'DISPID_SDKEnumValues',
    '_ISpeechVoiceEvents', 'SpeechPropertyComplexResponseSpeed',
    'SPAO_RETAIN_AUDIO', 'ISpeechObjectTokenCategory',
    'DISPID_SGRsDynamic', 'DISPID_SLPPartOfSpeech',
    'SpNullPhoneConverter', 'SpeechGrammarTagDictation',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SLAddPronunciation',
    'SDTAlternates', 'SPCONTEXTSTATE', 'DISPID_SOTCreateInstance',
    'DISPID_SRGSetTextSelection', 'SPPS_LMA', 'SPAR_Unknown',
    'DISPID_SpeechRecoResultTimes', 'SpInProcRecoContext',
    'DISPID_SpeechPhraseRule', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCCmdMaxAlternates', 'SAFT32kHz8BitStereo',
    'SPCATEGORYTYPE', 'DISPID_SPCLangId', 'eLEXTYPE_RESERVED9',
    'SpeechAddRemoveWord', 'ISpGrammarBuilder', 'DISPID_SBSSeek',
    'DISPID_SVPause', 'DISPID_SpeechRecoResult2',
    'ISpeechRecoResultDispatch', 'SPSHT_EMAIL',
    'DISPID_SDKGetlongValue', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE14', 'ISpMMSysAudio', 'DISPID_SPEsItem',
    'SAFT8kHz8BitStereo', 'DISPID_SLPs_NewEnum', 'SPSHORTCUTPAIR',
    'SPCT_COMMAND', 'SVP_21', 'DISPID_SGRSTText', 'ISpEventSource',
    'SRSInactive', 'SPEI_VOICE_CHANGE', 'SpeechEmulationCompareFlags',
    'SpPhoneConverter', 'SDKLCurrentConfig',
    'DISPID_SpeechObjectTokens'
]

_check_version('1.2.0', 1697901166.038182)
